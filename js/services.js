...
services.factory('AppModel', function ($http, $log, $rootScope, $routeParams, $location, LAYOUT) {
    ...
    var items = [
      {name:'Nathan', id:'world-connections', info:'http://blog.dewmap.com/post/50c68dfbe16b160200000001'},
      {name:'Chelsey', id:'abstract-tech-01', info:'http://blog.dewmap.com/post/50cecc093926bd0200000001'},
      {name:'Aaron', id:'fb-og-d3', info:'http://blog.dewmap.com/post/50f61b8a9f9b0d0200000001'},
      {name:'Alexa', id:'pie-menu-d3', info:'http://blog.dewmap.com/post/50ff83c23f9c1f0200000001'},
      {name:'Ashley', id:'world-connections', info:'http://blog.dewmap.com/post/50c68dfbe16b160200000001'}
    ];
